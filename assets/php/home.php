...
<body>
	...
	<section class="title">
		...
		<nav class=" " style="background-color: #1B9410">
	      <h3 style="font-size: 2rem; text-align: center; color: #fff; margin: 0% auto; padding: 0.3% 3%  0.7%; letter-spacing: 0.15em; word-spacing: 0.25em; font-weight: 800; font-family: sans-serif;"> 
		  ...
		  <div class="container">
		  	...
		  	<div class="jumbotron">
					...
					<ul type="square" style="text-align: justify;">
						<p>
							<li>
								This Portal is use to Guide the student about how to conduct their SIWES, how to choose organisation/industrial attachment, and Area of specialization in the industry
							</li>
							<li>
								You can take your SIWES Activities on this Website from the ealy  stage 
								to the End <em>(choosing the siwes industry to siwes Defence)</em>.
							</li>
							<li>
								This Website is use to assist the SIWES students to keep record of their training, it will 
								show the Department and sections which the student has worked and the time spent in such unit.
							</li>
						</p>
						<hr>
						<p>
							<li>
								The Daily work carried out during the period of training is to recorded clearly with sketches and diagrams where applicable. 
							</li>
							<li>
								The SIWES Supervisor will check the record of each Studends at regular intervals to ensure that the proper training is being received and record his comments on the appropriate web page.
							</li>
							<li>
								And student can ask any question about siwes and get respond in time on 
								this website .
								<em  style="color: #af1d1d;"><big>Goto to the top of the website and click on your own choise button to 
								continue  the siwes activities.</big></em>
							</li>
						</p>
					</ul>
			  </div>
			  ...
			  <div class="jumbotron">
					<h3>About SIWES</h3>
					<hr>
					<img class="aboutsiwesimg" src="../images/siwes8.png" alt="aboutsiwesimg">
					<p>
					...
					<hr>
					<img class="aboutsiwesimgright" src="../images/siwes5.jpg" alt="aboutsiwesimg">
					<p>
			  ...
			  <div class="jumbotron">
				  	<p>
						<button class="btn btn-lg btn-success"><a href="about.php" class="nav-link">Read More About SIWES</a></button>
					</p>
					<div class="jumbotron">
						<p>
