    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success  ahover" style="font-size:115%; ">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">MonthlyReport</a>
              </li>
              <li class="nav-item">
  ...
  <section class="bodytext">
      <div class="container">
          ...
          <div style=" padding: 1% 0; width: 65%; margin: auto;">
            <p>
              Upload your Monthly progress Report: Week1, Week2, Week3, Week4, Include your
              sketch / Diagram.
            </p>
            <hr>
              <h3>
           ...
           <div class="container">
                  <form class="logform" method="post" action="login.php">
                    ...
                    <div class="d-grid gap-2">
                      <h1 style="color:MediumSeaGreen">1<sup>st</sup> Month</h1>
                    	<div class="row" id="rowmargin">
                              ...
                              <div class="inputmargin">
                                <label>Week3</label>
                                <input type="file" name="week3" placeholder="week3">
                              </div>  
                          </div>
                      		<div class="col-lg-6 col-md-6">
                              <div class="inputmargin">
                                <label>Week4</label>
                                <input type="file" name="week4" placeholder="week4">
                              </div>  
                          </div>
                    	</div>
                      <!-- submit button -->
