...
<head>
 ...
 <!-- Internal Style -->
	  ...
	  <link rel="stylesheet" type="text/css" href="../css/indreg.css">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-success  ahover" style="font-size:115%; ">
	        ...
	        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		        <ul class="navbar-nav ml-auto">
		          <li class="nav-item">
		            <a href="#" class="nav-link">IndustrialRegistration</a>
		          </li>
		          <li class="nav-item">
		  ...
		  <div class="container">
		  	  ...
		  	  <div class="jumbotron">
					...
					<div style=" padding: 1% 0; width: 60%; margin: auto;">
						<hr>
						<p>
							Please login Students! should make sure that All information about industrial attached you fill it Correctly and true.
					    </p>
					    <h3>
							Registration of Industrial Being Attached &#8631;
						</h3>
					</div>
                    ...
                    <!--================= Form Section=================-->
					 <div class="container">
				          <form class="logform" method="post" action="login.php">
				          	<h1 style="color:MediumSeaGreen">Student Information</h1>
				            ...
				            <div class="d-grid gap-2">
				                ...
				                <div class="inputmargin">
				                  <input type="text" name="program" placeholder="Program of Study">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="level" placeholder="Level">
				                </div>
				                <h1 style="color:MediumSeaGreen">Industrial Information</h1>
				                <div class="inputmargin">
				                  <input type="text" name="indname" placeholder="Name of Industrial being Attached">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="location" placeholder="Location">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="areaspec" placeholder="Area of Specialization in the Industry">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="siwesyear:" placeholder="Siwes Year">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="duration" placeholder="Duration">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="startfrom" placeholder="Start from">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="endat" placeholder="End at">
				                </div>
				                <div class="inputmargin">
				                  <input type="text" name="indspvrname"placeholder="Name of Industrial base Supervisor">
				                </div>
				                <!-- Latitude -->
				                <div class="inputmargin">
