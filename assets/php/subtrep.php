...
<head>
	...
	<title>Submitting SIWES Report</title>

	 <!-- Internal Style -->
  	<link rel="icon" type="text/css" href="../images/fud.png">
    <link rel="stylesheet" type="text/css" href="../css/all.css">
    <link rel="stylesheet" type="text/css" href="../css/monthrep.css">
...
<!--================= Header Section =================-->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success  ahover" style="font-size:115%; ">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">SubmittingOfTechReport</a>
              </li>
              <li class="nav-item">
  ...
  <section class="bodytext">
      <div class="container">
          ...
          <div style=" padding: 1% 0; width: 65%; margin: auto;">
            <!-- <p>
              Upload your SIWES Report (Technical Report & Power point Slide) 
            </p> -->
            <hr>
              <h3>
                   Submitting of SIWES Report &#8631;
              </h3>
              <p>
                 <em  style="color: #af1d1d;"><b>Upload your SIWES Report(Technical Report & Power point Slide)</b></em>
              </p>
          </div>
                    ...
                    <div class="d-grid gap-2">
                    	<div class="row" id="rowmargin">
                              ...
                              <div class="inputmargin">
                                ...
                                <input type="file" name="week1" placeholder="week1">
                              </div>  
                          </div>
                      		<div class="col-lg-6 col-md-6">
                              <div class="inputmargin">
                                <label>Power point slide</label>
                                <input type="file" name="week2" placeholder="week2">
                              </div>  
                          </div>
                    	</div>
                      <!-- submit button -->
                      <div class="inputmargin">
                        <input type="submit" name="login_user" value="Upload 📤" class="btn btn-lg btn-success" style="width: 80%">
                      </div>
                    </div>
                  </form>
              </div>
